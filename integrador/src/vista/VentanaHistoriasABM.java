...
public class VentanaHistoriasABM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEliminar.setToolTipText("eliminar la historia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaHistoriasABM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaHistoriasABM().setVisible(true);
            }
        });
    }
